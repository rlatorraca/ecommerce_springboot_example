...
public class _01_TestDataToInsertShippingIntoCartMelhorEnvio {

    /* INSER / CRIAR as TAGS para depois comprar o FRETE */
    public static void main(String[] args) throws IOException {
        try (InputStream input = _01_TestDataToInsertShippingIntoCartMelhorEnvio.class.getClassLoader().getResourceAsStream("tokensapi.properties")) {
            ...
            Request request = new Request.Builder()
                    .url(prop.getProperty("url.melhorenvio.sandbox") + "/api/v2/me/cart")
                    .method("POST", body)

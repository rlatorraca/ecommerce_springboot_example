...
public class _02_TestBuyShippingCheckoutMelhorEnvio {

    /* COMPRA AS TAGs para o FRETE */
    public static void main(String[] args) throws IOException {
        try (InputStream input = _02_TestBuyShippingCheckoutMelhorEnvio.class.getClassLoader().getResourceAsStream("tokensapi.properties")) {
            ...
            Request request = new Request.Builder()
                    .url(prop.getProperty("url.melhorenvio.sandbox") + "/api/v2/me/shipment/checkout")
                    .method("POST", body)

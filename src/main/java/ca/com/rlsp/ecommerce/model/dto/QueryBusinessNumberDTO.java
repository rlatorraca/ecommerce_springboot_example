...
public class QueryBusinessNumberDTO implements Serializable {

    private static final long serialVersionUID = 1L;

    private List<ActivityDTO> atividade_principal = new ArrayList<ActivityDTO>();
    ...
    private List<ActivityDTO> atividades_secundarias = new ArrayList<ActivityDTO>();

    private List<CorporateStructureDTO> qsa = new ArrayList<CorporateStructureDTO>();
    ...
    public List<ActivityDTO> getAtividade_principal() {
        return atividade_principal;
    }

    public void setAtividade_principal(List<ActivityDTO> atividade_principal) {
    ...
    public List<ActivityDTO> getAtividades_secundarias() {
        return atividades_secundarias;
    }

    public void setAtividades_secundarias(List<ActivityDTO> atividades_secundarias) {
        this.atividades_secundarias = atividades_secundarias;
    }

    public List<CorporateStructureDTO> getQsa() {
        return qsa;
    }

    public void setQsa(List<CorporateStructureDTO> qsa) {
        this.qsa = qsa;
    }

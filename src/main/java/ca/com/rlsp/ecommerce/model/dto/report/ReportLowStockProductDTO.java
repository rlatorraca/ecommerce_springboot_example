...
public class ReportLowStockProductDTO implements Serializable {
    ...
    private String alertStockQuantity="";
    ...
    public String getMinimumStockQuantity() {
        return minimumStockQuantity;
    }

    public void setMinimumStockQuantity(String minimumStockQuantity) {
        this.minimumStockQuantity = minimumStockQuantity;
    }

    public String getAlertStockQuantity() {
        return alertStockQuantity;
    }

    public void setAlertStockQuantity(String alertStockQuantity) {
